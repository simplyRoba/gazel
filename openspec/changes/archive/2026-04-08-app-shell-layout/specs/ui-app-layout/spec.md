...
The root layout SHALL render an app shell consisting of a navigation region and a content region. The content region SHALL render the active route's page content.
