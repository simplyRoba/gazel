...
Consistent JSON error handling for the API: a uniform error response shape, error-variant-to-HTTP-status mapping, database error and custom extractor helpers, nullable-field deserialization, and stable error codes (vehicle, fill-up) usable as i18n keys.
