...
CRUD API for vehicles: list, get, create, update (full replace), patch (partial update), and delete endpoints, with fuel-type and year validation and a defined response shape.
