...
Aggregate fuel-efficiency and cost statistics for a vehicle: a summary stats endpoint, a history endpoint, the segment calculation algorithm, time-range filtering, and unit-system-aware responses.
